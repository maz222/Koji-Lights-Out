                            ...
                            row.map((cellValue,cellIndex) => {
                                switch(cellValue) {
                                    ...
                                    case 1:
                                        return <LitCell />;
                                    case 2:
                                        return <TargetLit onClick={() => {this.props.audio.playAudio(2); this.props.audio.playAudio(1); this.setState({completed:true})}}><TargetIndicator src={this.props.active}/></TargetLit>
                                }
                            })
                        )
                    })
